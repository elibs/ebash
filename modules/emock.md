...
Usage: assert_emock_called [option]... name times 
...
(&) Denotes options which can be given multiple times
   ...
   --statedir <value>
         This directory is used to track state about mocked binaries. This will hold metadata information such as
         the number of times the mock was called as well as the exit code, stdout, and stderr for each invocation.
...
Usage: assert_emock_called_with [option]... name num [expect]...
...
Usage: assert_emock_return_code [option]... name num return_code 
...
Usage: assert_emock_stderr [option]... name num stderr 
...
Usage: assert_emock_stdin [option]... name num stdin 
...
Usage: assert_emock_stdout [option]... name num stdout 
...
(&) Denotes options which can be given multiple times
   ...
   --statedir <value>
         This directory is used to track state about mocked binaries. This will hold metadata information such as
         the number of times the mock was called as well as the return code, stdout, and stderr for each invocation.
   ...
   --textfile, -t
         Treat the body as a simple text file rather than a shell script. In this mode there will be no generated
         stdin, stdout or stderr and the mock will not be executable. The additional tracking emock does around
         how many times a mock is called is also disabled when in this mode. This is suitable for mocking out
...
ARGUMENTS
   ...
   name
         Name of the binary to mock (e.g. dmidecode or /usr/sbin/dmidecode). This must match the calling convention
         at the call site.

   body
         This allows fine-grained control over the body of the mocked function that is created. Instead of
         using return_code, stdout, and stderr, you can directly provide the entire body of the script in this
         string. The syntax of this is single quotes with enclosing curly braces. This is identical to what you
         would use with override_function.
...
Usage: emock_args [option]... name [num] 
...
Usage: emock_called [option]... name 
...
Usage: emock_dump_all_state [option]... 
...
Usage: emock_dump_state [option]... name 
...
Usage: emock_indexes [option]... name 
...
Usage: emock_return_code [option]... name [num] 
...
Usage: emock_stderr [option]... name [num] 
...
Usage: emock_stdin [option]... name [num] 
...
Usage: emock_stdout [option]... name [num] 
