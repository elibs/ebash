...
(&) Denotes options which can be given multiple times
   ...
   --kill-after, -k <value>
         Elevate to SIGKILL after waiting for this duration after sending the initial signal.  Accepts any duration
         that sleep would accept. By default no elevated signal is sent
...
Usage: process_parent_tree [option]... [pid] 
