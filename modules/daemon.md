...
Usage: daemon_pack_save optpack 
...
Usage: daemon_restart [option]... optpack 
...
(&) Denotes options which can be given multiple times
   ...
   --cgroup-timeout, -c <value>
         Seconds after SIGKILL to wait for processes to actually disappear. Requires cgroup support. If you specify
         a c=<some number of seconds>, we'll give up (and return an error) after that many seconds have elapsed. By
         default, this is 300 seconds. If you specify 0, this will wait forever.
...
Usage: daemon_status [option]... optpack 
...
Usage: daemon_stop [option]... optpack 
