...
Usage: lower_snake_case_to_title_case [input] 
...
Usage: string_getline [input] num 
...
Usage: string_truncate [option]... length 
...
Usage: to_lower_snake_case input 
...
Usage: to_upper_snake_case input 
