...
Usage: cgroup_empty [option]... [cgroups]...
...
Usage: cgroup_find_setting_file cgroup setting 
...
Usage: cgroup_get cgroup setting 
...
Usage: cgroup_kill [option]... [cgroups]...
...
Usage: cgroup_kill_and_wait [option]... [cgroups]...
...
(&) Denotes options which can be given multiple times
   ...
   --timeout, --max, -t <value>
         Maximum number of seconds to wait for all processes to die. If some still exist at that point, an error
         code will be returned. WARNING: The default of 0 will cause this function to wait forever.
...
Usage: cgroup_pids [option]... [cgroups]...
...
Usage: cgroup_set cgroup setting value 
