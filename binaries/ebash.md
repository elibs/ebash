...
(&) Denotes options which can be given multiple times
   ...
   --name, -n <value>
         Name to use as a starting point for finding functions. This basically pretends that ebash is running with
         the specified name.
   ...
   --source, -s
         Print commands that would load ebash from its existing location on disk into the current shell and then
         exit. You'd use this in a script like this: $(ebash --source)
